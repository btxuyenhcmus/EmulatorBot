...
def scroll_smooth_to_end(driver):
    ...
    height = int(driver.execute_script("return Math.max(document.body.scrollHeight, document.body.offsetHeight, document.documentElement.clientHeight, document.documentElement.scrollHeight, document.documentElement.offsetHeight);"))
...
def scroll_smooth_to_top(driver):
    ...
    scroll_position = int(driver.execute_script("return Math.max(document.body.scrollHeight, document.body.offsetHeight, document.documentElement.clientHeight, document.documentElement.scrollHeight, document.documentElement.offsetHeight);"))
...
def click_random_top_result(driver):
    ...
    random_link = random.choice(result_links[:5])
    random_link.click()
    time.sleep(10)
...
def click_random_page(driver):
    ...
    random_link = random.choice(all_links[:100])
    random_link.click()
    time.sleep(10)
